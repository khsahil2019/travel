        ...
        child: Column(children: [
              ...
              child: GestureDetector(
                onTap: () {
                  ...
                  Get.to(() => BestDealsDetail(),
                      arguments: authController.dealsList.indexOf(x));
                },
                child: Container(
                  //height: 200,
          ...
          for (var x in authController.exoticplaceList)
            Padding(
              ...
              child: GestureDetector(
                onTap: () {
                  print(authController.exoticplaceList.indexOf(x));
                  Get.to(() => ExoticLocationDetail(),
                      arguments: authController.exoticplaceList.indexOf(x));
                },
                child: Container(
                  width: double.infinity,
                  decoration: BoxDecoration(
          ...
          for (var x in authController.destinationWeddingList)
            Padding(
              ...
              child: GestureDetector(
                onTap: () {
                  print(authController.destinationWeddingList.indexOf(x));
                  Get.to(() => WeddingDestinationDetailScreen(),
                      arguments:
                          authController.destinationWeddingList.indexOf(x));
                },
                child: Container(
                  width: double.infinity,
                  decoration: BoxDecoration(
